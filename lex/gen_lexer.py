            ...
            match states[-1][0]:
                case 0:
                    ...
                    if ch == '':
                        ...
                        continue
                    if ch in ('Z', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'v', 'w', 'x', 'y', 'z', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'M', 'N', 'O', 'P', '_', 'Q', 'a', 'R', 'b', 'S', 'c', 'T', 'd', 'e', 'V', 'f', 'W', 'g', 'X', 'h', 'Y', 'i'):
                ...
                case 1:
                    if ch == '\\':
                        ...
                        continue
                    if ch in ('z', 'U', 'e', 'A', 'V', 'f', 'B', 'W', 'g', 'C', 'X', 'h', 'D', 'Y', 'i', 'E', 'Z', 'j', '0', 'F', 'k', '1', 'G', 'l', '2', 'H', 'm', '3', 'I', 'n', '4', 'J', 'o', '5', 'K', 'p', '6', 'L', 'q', '7', 'M', 'r', '8', 'N', 's', '9', 'O', 't', 'P', 'u', '_', 'Q', 'v', 'a', 'R', 'w', 'b', 'S', 'x', 'c', 'T', 'y', 'd'):
                        states.append((1, self.reader.save()))
                        continue
                ...
                case 13:
                    ...
                    if ch == "'":
                        states.append((18, self.reader.save()))
                        continue
                    if ch in ('z', 'U', 'e', 'A', 'V', 'f', 'B', 'W', 'g', 'C', 'X', 'h', 'D', 'Y', 'i', 'E', 'Z', 'j', '0', 'F', 'k', '1', 'G', 'l', '2', 'H', 'm', '3', 'I', 'n', '4', 'J', 'o', '5', 'K', 'p', '6', 'L', 'q', '7', 'M', 'r', 'N', 's', '9', 'O', 't', 'P', 'u', '_', 'Q', 'v', 'a', 'R', 'w', 'b', 'S', 'x', 'c', 'T', 'y', 'd'):
                        states.append((1, self.reader.save()))
                        continue
                    if self.other_identifier_continue(ch):
                        states.append((1, self.reader.save()))
                ...
                case 33:
                    if ch == '.':
                        ...
                        continue
                    if ch in ('b', 'a', '3', 'A', 'c', '4', 'B', 'd', '5', 'C', 'e', '6', 'D', 'f', '7', 'E', '8', 'F', '0', '9', '1', '2'):
                ...
                case 57:
                    ...
                    break
                case 58:
                    if ch in ('9', '4', 'E', 'f', 'a', '5', 'F', 'D', 'A', '0', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'e'):
                ...
                case 65:
                    ...
                    if ch == 'p':
                        ...
                        continue
                    if ch in ('6', 'E', '8', 'c', '7', '0', 'F', '9', 'd', '1', 'a', 'e', '2', 'b', 'f', '3', 'A', '4', 'B', '5', 'C', 'D'):
                        states.append((65, self.reader.save()))
                        continue
                    if ch in ('u', 'U'):
                ...
                case 79:
                    ...
                    break
                case 80:
                    if ch in ('f', 'a', '5', 'F', '0', 'A', 'b', '6', 'B', '1', 'c', '7', '2', 'C', 'd', 'E', '8', '3', 'D', 'e', '9', '4'):
                ...
                case 89:
                    ...
                    break
                case 90:
                    if ch in ('2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', '1', 'c', 'B', '7'):
                ...
                case 95:
                    ...
                    break
                case 96:
                    if ch in ('1', 'c', '3', 'e', '2', 'd', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', 'F', '0', 'b'):
                        states.append((138, self.reader.save()))
                        continue
                    break
                case 97:
                    if ch in ('a', 'F', '9', '0', 'E', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D'):
                ...
                case 120:
                    ...
                    if ch == 'P':
                        states.append((155, self.reader.save()))
                        continue
                    if ch in ('d', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', '2', 'b', '6', '1', 'B', 'c', '7', 'C'):
                        states.append((120, self.reader.save()))
                        continue
                    break
                case 121:
                ...
                case 126:
                    ...
                    break
                case 127:
                    if ch in ('1', 'B', 'c', '0', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', 'b', '6'):
                ...
                case 129:
                    ...
                    if ch == "'":
                        states.append((93, self.reader.save()))
                        continue
                    if ch in ('4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e'):
                        states.append((129, self.reader.save()))
                        continue
                    if self.other_c_char(ch):
                        states.append((50, self.reader.save()))
                    ...
                    break
                case 130:
                    if ch in ('6', '1', 'B', 'c', '0', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', 'b'):
                ...
                case 132:
                    ...
                    break
                case 133:
                    if ch in ('b', '6', '1', 'B', 'c', '7', 'F', '2', 'C', 'd', '8', '0', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'A'):
                        states.append((172, self.reader.save()))
                        continue
                    break
                case 134:
                    if ch in ('B', '7', 'c', '2', 'C', '8', 'd', '3', 'D', '9', 'e', '4', 'E', 'a', 'f', '5', '0', 'F', 'b', 'A', '6', '1'):
                        states.append((173, self.reader.save()))
                        continue
                    break
                case 135:
                    if ch in ('9', '4', 'f', 'E', 'a', '5', 'A', '0', 'F', 'b', '6', '1', 'B', 'c', 'D', '7', '2', 'C', 'd', '8', '3', 'e'):
                ...
                case 137:
                    ...
                    if ch == '"':
                        states.append((53, self.reader.save()))
                        continue
                    if ch in ('f', '3', 'A', '4', 'B', '5', 'C', '6', 'D', '7', 'E', '8', '0', 'F', '9', '1', 'a', '2', 'b', 'c', 'd', 'e'):
                        states.append((137, self.reader.save()))
                        continue
                    if self.other_s_char(ch):
                        states.append((52, self.reader.save()))
                    ...
                    break
                case 138:
                    if ch in ('c', '0', 'F', '2', 'b', 'd', '1', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a'):
                ...
                case 142:
                    ...
                    break
                case 143:
                    if ch in ('b', '2', 'd', '1', 'c', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', '0', 'F'):
                        states.append((180, self.reader.save()))
                        continue
                    break
                case 144:
                    if ch in ('c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', '1', 'b', '6', 'B'):
                        states.append((181, self.reader.save()))
                        continue
                    break
                case 145:
                    if ch in ('e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', '0', 'b', '6', '1', 'B', 'c', '7', 'D', '2', 'C', 'd', '8', '3'):
                ...
                case 152:
                    ...
                    break
                case 153:
                    if ch in ('8', '3', '6', '1', '9', '4', '7', '2', '5', '0'):
                        states.append((152, self.reader.save()))
                        continue
                    break
                case 154:
                    if ch in ('6', '1', '9', '0', '4', '7', '2', '5', '8', '3'):
                ...
                case 162:
                    ...
                    if ch in ('F', 'L', 'f', 'l'):
                        states.append((76, self.reader.save()))
                        continue
                    if ch in ('4', '9', '5', '0', '6', '1', '7', '2', '8', '3'):
                        states.append((162, self.reader.save()))
                        continue
                    break
                case 163:
                    if ch in ('3', '6', '1', '9', '4', '7', '8', '2', '5', '0'):
                        states.append((162, self.reader.save()))
                        continue
                    break
                case 164:
                    if ch in ('d', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', 'C', '6', '1', 'B', 'c', '7', '2'):
                        states.append((120, self.reader.save()))
                        continue
                    break
                case 165:
                ...
                case 168:
                    ...
                    break
                case 169:
                    if ch in ('5', 'F', '0', 'A', 'b', '6', 'E', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'f', 'a'):
                ...
                case 172:
                    ...
                    break
                case 173:
                    if ch in ('0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'F', 'e', '9', '4', 'E', 'f', 'a', '5'):
                ...
                case 174:
                    ...
                    break
                case 175:
                    if ch in ('9', 'b', 'E', '1', 'a', 'c', 'F', '0', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D'):
                ...
                case 179:
                    ...
                    if ch == '"':
                        states.append((53, self.reader.save()))
                        continue
                    if ch in ('2', 'f', '3', 'A', '4', 'B', '5', 'C', '6', 'D', '7', 'E', '8', 'F', '0', '9', '1', 'a', 'b', 'c', 'd', 'e'):
                        states.append((179, self.reader.save()))
                        continue
                    if self.other_s_char(ch):
                        states.append((52, self.reader.save()))
                ...
                case 181:
                    ...
                    break
                case 182:
                    if ch in ('C', 'd', '3', '8', 'D', 'e', '9', '4', 'E', 'f', '5', 'a', '0', '7', 'F', 'A', '6', 'b', '1', 'B', 'c', '2'):
                        states.append((1, self.reader.save()))
                        continue
                    break
                case 183:
                ...
                case 191:
                    ...
                    break
                case 192:
                    if ch in ('e', '4', '9', 'E', 'f', '5', 'a', '0', 'F', 'A', 'b', '6', '1', 'B', '7', 'c', '2', 'C', '8', 'd', '3', 'D'):
                        states.append((206, self.reader.save()))
                        continue
                    break
                case 193:
                    if ch in ('0', '6', '1', 'F', 'c', 'B', '7', '2', 'd', 'C', '8', '3', 'e', 'D', '9', '4', 'f', 'E', 'a', '5', 'A', 'b'):
                        states.append((50, self.reader.save()))
                        continue
                    break
                case 194:
                ...
                case 195:
                    ...
                    break
                case 196:
                    if ch in ('E', '8', 'D', 'a', 'F', '9', '0', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C'):
                ...
                case 198:
                    ...
                    break
                case 199:
                    if ch in ('a', 'D', 'F', '0', '9', 'b', 'E', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8'):
                        states.append((211, self.reader.save()))
                        continue
                    break
                case 200:
                    if ch in ('3', 'C', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', '0', 'b', '6', '1', 'B', 'c', '7', '2', 'd', '8'):
                ...
                case 205:
                    ...
                    break
                case 206:
                    if ch in ('1', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', 'B'):
                        states.append((214, self.reader.save()))
                        continue
                    break
                case 207:
                    if ch in ('3', 'D', 'e', '9', '4', 'C', 'E', 'f', 'a', '5', 'F', 'A', '0', 'b', '6', '1', 'B', 'c', '7', '2', 'd', '8'):
                ...
                case 208:
                    ...
                    break
                case 209:
                    if ch in ('C', '6', 'B', '8', 'D', '7', '9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A'):
                ...
                case 210:
                    ...
                    break
                case 211:
                    if ch in ('7', '9', 'C', 'E', '8', 'a', 'D', '0', 'F', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B'):
                ...
                case 214:
                    ...
                    break
                case 215:
                    if ch in ('b', 'F', '1', '6', 'B', 'c', '2', '7', 'C', 'd', '8', '3', 'D', 'e', '4', '9', 'E', 'f', '5', 'a', '0', 'A'):
                ...
                case 219:
                    ...
                    break
                case 220:
                    if ch in ('f', 'a', '5', 'F', '0', 'A', 'b', '6', 'E', 'B', '1', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4'):
                        states.append((225, self.reader.save()))
                        continue
                    break
                case 221:
                    if ch in ('a', '5', 'F', '0', 'A', 'b', '6', 'E', 'B', '1', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'f'):
                        states.append((226, self.reader.save()))
                        continue
                    break
                case 222:
                    if ch in ('3', '5', 'e', 'A', '4', '6', 'f', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', '0', 'F', 'b', '1', 'c', '2', 'd'):
                ...
                case 224:
                    ...
                    break
                case 225:
                    if ch in ('8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '0', '5', 'F', 'A', 'b', '1', '6', 'B', 'c', '2', '7', 'C', 'd'):
                        states.append((50, self.reader.save()))
                        continue
                    break
                case 226:
                    ...
                    break
                case 227:
                    if ch in ('e', '2', 'd', '4', 'f', '3', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', 'F', '0', 'b', '1', 'c'):
                        states.append((52, self.reader.save()))
                        continue
                    break
                case 228:
                    ...
                    break
                case 229:
                    if ch in ('d', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', '1', 'B', 'c', 'C', '7', '2'):
                        states.append((50, self.reader.save()))
                        continue
                    break
                case 230:
                    if ch in ('1', '3', 'c', 'e', '2', '4', 'd', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', '0', 'F', 'b'):
                        states.append((52, self.reader.save()))
                        continue
                    break
                case _:
