            ...
            match states[-1][0]:
                case 0:
                    ...
                    if ch == '':
                        ...
                        continue
                    if ch in ('o', 'p', 'q', 'r', 's', 't', 'v', 'w', 'x', 'y', 'z', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'M', 'N', 'O', 'P', '_', 'Q', 'a', 'R', 'b', 'S', 'c', 'T', 'd', 'e', 'V', 'f', 'W', 'g', 'X', 'h', 'Y', 'i', 'Z', 'j', 'k', 'l', 'm', 'n'):
                ...
                case 3:
                    if ch == '\\':
                        ...
                        continue
                    if ch in ('Z', 'E', '0', 'j', 'F', '1', 'k', 'G', '2', 'l', 'H', '3', 'm', 'I', 'n', '4', 'J', '5', 'o', 'K', '6', 'p', 'L', '7', 'q', 'M', '8', 'r', 'N', '9', 's', 'O', 't', 'P', '_', 'u', 'Q', 'a', 'v', 'R', 'b', 'w', 'S', 'c', 'x', 'T', 'y', 'd', 'U', 'i', 'e', 'z', 'V', 'f', 'A', 'W', 'g', 'B', 'X', 'h', 'C', 'Y', 'D'):
                        states.append((3, self.reader.save()))
                        continue
                ...
                case 10:
                    ...
                    if ch == "'":
                        states.append((15, self.reader.save()))
                        continue
                    if ch in ('Z', 'E', '0', 'j', 'F', '1', 'k', 'G', '2', 'l', 'H', '3', 'm', 'I', 'n', '4', 'J', '5', 'o', 'K', '6', 'p', 'L', '7', 'q', 'M', 'r', 'N', '9', 's', 'O', 't', 'P', '_', 'u', 'Q', 'a', 'v', 'R', 'b', 'w', 'S', 'c', 'x', 'T', 'y', 'd', 'U', 'i', 'e', 'z', 'V', 'f', 'A', 'W', 'g', 'B', 'X', 'h', 'C', 'Y', 'D'):
                        states.append((3, self.reader.save()))
                        continue
                    if self.other_identifier_continue(ch):
                        states.append((3, self.reader.save()))
                ...
                case 13:
                    ...
                    if ch == '"':
                        states.append((16, self.reader.save()))
                        continue
                    if ch in ('Z', 'E', '0', 'j', 'F', '1', 'k', 'G', '2', 'l', 'H', '3', 'm', 'I', 'n', '4', 'J', '5', 'o', 'K', '6', 'p', 'L', '7', 'q', 'M', '8', 'r', 'N', '9', 's', 'O', 't', 'P', '_', 'u', 'Q', 'a', 'v', 'R', 'b', 'w', 'S', 'D', 'c', 'x', 'T', 'y', 'd', 'U', 'i', 'e', 'z', 'V', 'f', 'A', 'W', 'g', 'B', 'X', 'h', 'C', 'Y'):
                        states.append((3, self.reader.save()))
                        continue
                    if self.other_identifier_continue(ch):
                        states.append((3, self.reader.save()))
                ...
                case 28:
                    if ch == '.':
                        ...
                        continue
                    if ch in ('E', 'f', 'B', '8', 'F', '0', 'A', 'C', '9', '1', 'D', 'a', '2', 'b', '3', 'c', '4', 'd', '7', '5', 'e', '6'):
                ...
                case 46:
                    ...
                    break
                case 47:
                    if ch in ('0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'F', 'f', 'a', '5'):
                ...
                case 62:
                    ...
                    if ch == 'W':
                        ...
                        continue
                    if ch in ('b', '4', 'B', 'd', 'c', '5', 'C', 'e', '6', 'D', 'f', '7', 'E', 'A', '3', '8', 'F', '0', '9', '1', 'a', '2'):
                        states.append((62, self.reader.save()))
                        continue
                    if ch in ('u', 'U'):
                ...
                case 77:
                    ...
                    break
                case 78:
                    if ch in ('F', 'b', '6', '1', 'B', '0', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'A'):
                        states.append((124, self.reader.save()))
                        continue
                    break
                case 79:
                    if ch in ('e', '9', '4', 'E', 'f', 'D', 'a', '5', 'F', 'A', '0', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3'):
                ...
                case 86:
                    ...
                    break
                case 87:
                    if ch in ('2', 'C', '8', 'd', '3', 'D', '9', 'e', '4', 'E', 'a', 'f', '5', 'B', '0', 'F', 'b', 'A', '6', '1', 'c', '7'):
                ...
                case 88:
                    ...
                    break
                case 89:
                    if ch in ('7', '2', 'C', 'd', '8', '1', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', 'B', 'c'):
                        states.append((129, self.reader.save()))
                        continue
                    break
                case 90:
                    if ch in ('4', 'E', 'f', 'D', 'a', '5', 'F', '0', 'A', 'b', '6', 'B', '1', 'c', '7', '2', 'C', 'd', '8', '3', 'e', '9'):
                        states.append((130, self.reader.save()))
                        continue
                    break
                case 91:
                    if ch in ('1', 'B', 'A', '7', 'c', '2', 'C', '8', 'd', '3', 'D', '9', 'e', '4', 'E', 'a', 'f', '5', '0', 'b', 'F', '6'):
                ...
                case 105:
                    ...
                    if ch == 'P':
                        ...
                        continue
                    if ch in ('b', '6', 'A', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', '5', 'f', 'a', 'F', '0'):
                        states.append((109, self.reader.save()))
                        continue
                    break
                case 106:
                    if ch in ('0', '8', '5', '3', '6', '1', '9', '4', '7', '2'):
                ...
                case 123:
                    ...
                    break
                case 124:
                    if ch in ('E', 'a', 'f', '5', '0', 'F', 'b', 'A', '6', '1', 'c', 'B', '7', '2', 'd', 'C', '8', '3', 'e', 'D', '9', '4'):
                        states.append((165, self.reader.save()))
                        continue
                    break
                case 125:
                    if ch in ('C', 'd', '7', '3', '8', 'D', 'e', '9', '4', 'E', 'f', '5', 'a', '0', 'F', 'A', '6', 'b', '1', 'B', 'c', '2'):
                        states.append((166, self.reader.save()))
                        continue
                    break
                case 126:
                    if ch in ('8', '3', 'D', 'e', '9', 'C', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'd'):
                        states.append((167, self.reader.save()))
                        continue
                    break
                case 127:
                    if ch in ('b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', 'F', '4', 'E', 'f', 'a', '0', '5', 'A'):
                ...
                case 128:
                    ...
                    break
                case 129:
                    if ch in ('6', '1', 'c', 'B', '7', '2', 'd', 'C', '8', '3', '0', 'e', 'D', '9', 'F', '4', 'f', 'E', 'a', '5', 'A', 'b'):
                ...
                case 131:
                    ...
                    if ch == "'":
                        states.append((93, self.reader.save()))
                        continue
                    if ch in ('9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D'):
                        states.append((131, self.reader.save()))
                        continue
                    if self.other_c_char(ch):
                        states.append((50, self.reader.save()))
                ...
                case 132:
                    ...
                    break
                case 133:
                    if ch in ('1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', '0', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', 'b', '6'):
                ...
                case 139:
                    ...
                    if ch == '"':
                        states.append((53, self.reader.save()))
                        continue
                    if ch in ('E', '8', 'F', '9', '0', 'a', '1', 'b', '2', 'c', '3', 'd', '4', 'e', '5', 'f', '6', 'A', '7', 'B', 'C', 'D'):
                        states.append((139, self.reader.save()))
                        continue
                    if self.other_s_char(ch):
                        states.append((52, self.reader.save()))
                ...
                case 142:
                    ...
                    break
                case 143:
                    if ch in ('1', 'a', 'c', 'F', '0', '2', 'b', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E'):
                ...
                case 164:
                    ...
                    break
                case 165:
                    if ch in ('3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', 'C', 'A', '0', 'b', '6', '1', 'B', 'c', '7', '2', 'd', '8'):
                        states.append((189, self.reader.save()))
                        continue
                    break
                case 166:
                    if ch in ('6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '0', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', 'b'):
                        states.append((190, self.reader.save()))
                        continue
                    break
                case 167:
                    if ch in ('c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '1', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', 'B'):
                        states.append((3, self.reader.save()))
                        continue
                    break
                case 168:
                    if ch in ('a', '5', 'F', '0', 'A', 'b', '6', 'B', '1', 'E', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'f'):
                ...
                case 169:
                    ...
                    break
                case 170:
                    if ch in ('c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', '1', 'a', '5', '0', 'F', 'A', 'b', '6', 'B'):
                ...
                case 174:
                    ...
                    if ch == "'":
                        states.append((93, self.reader.save()))
                        continue
                    if ch in ('8', 'D', '9', 'E', 'a', '0', 'F', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C'):
                        states.append((174, self.reader.save()))
                        continue
                    if self.other_c_char(ch):
                        states.append((50, self.reader.save()))
                ...
                case 180:
                    ...
                    if ch == '"':
                        states.append((53, self.reader.save()))
                        continue
                    if ch in ('D', '7', 'E', '8', 'F', '9', '0', 'a', '1', 'b', '2', 'c', '3', 'd', '4', 'e', '5', 'f', '6', 'A', 'B', 'C'):
                        states.append((180, self.reader.save()))
                        continue
                    if self.other_s_char(ch):
                        states.append((52, self.reader.save()))
                ...
                case 186:
                    ...
                    break
                case 187:
                    if ch in ('6', '1', '9', '4', '8', '7', '2', '5', '0', '3'):
                        states.append((186, self.reader.save()))
                        continue
                    break
                case 188:
                    if ch in ('3', '6', '1', '8', '9', '4', '7', '2', '5', '0'):
                        states.append((153, self.reader.save()))
                        continue
                    break
                case 189:
                    if ch in ('7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', '1', 'F', '0', 'A', 'b', '6', 'B', 'c'):
                        states.append((3, self.reader.save()))
                        continue
                    break
                case 190:
                    if ch in ('5', 'F', '0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', 'E', '3', 'D', 'e', '9', '4', 'f', 'a'):
                ...
                case 192:
                    ...
                    break
                case 193:
                    if ch in ('0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', 'F', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5'):
                        states.append((50, self.reader.save()))
                        continue
                    break
                case 194:
                    if ch in ('4', 'E', 'a', 'f', '5', '0', 'F', 'b', 'A', '6', '1', 'c', 'B', '7', 'D', '2', 'd', 'C', '8', '3', 'e', '9'):
                ...
                case 196:
                    ...
                    break
                case 197:
                    if ch in ('a', '1', 'c', '0', 'F', 'b', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E'):
                        states.append((52, self.reader.save()))
                        continue
                    break
                case 198:
                    ...
                    break
                case 199:
                    if ch in ('F', 'c', '0', '2', 'b', 'd', '1', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a'):
                ...
                case 201:
                    ...
                    break
                case 202:
                    if ch in ('1', '9', '4', '7', '2', '8', '5', '0', '3', '6'):
                        states.append((184, self.reader.save()))
                        continue
                    break
                case 203:
                    if ch in ('1', '9', '4', '7', '2', '5', '0', '3', '8', '6'):
                        states.append((186, self.reader.save()))
                        continue
                    break
                case 204:
                ...
                case 206:
                    ...
                    break
                case 207:
                    if ch in ('d', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', '1', 'B', 'c', '7', 'C', '2'):
                ...
                case 209:
                    ...
                    break
                case 210:
                    if ch in ('3', 'e', '2', 'd', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', 'F', '0', 'b', '1', 'c'):
                        states.append((217, self.reader.save()))
                        continue
                    break
                case 211:
                    if ch in ('9', '0', 'E', 'b', 'a', '1', 'F', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D'):
                        states.append((52, self.reader.save()))
                        continue
                    break
                case 212:
                ...
                case 214:
                    ...
                    break
                case 215:
                    if ch in ('b', '6', '0', '1', 'B', 'c', '7', '2', 'C', 'F', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'A'):
                ...
                case 217:
                    ...
                    break
                case 218:
                    if ch in ('0', 'A', 'F', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5'):
                ...
                case 220:
                    ...
                    break
                case 221:
                    if ch in ('f', 'a', '5', 'F', '0', 'A', 'E', 'b', '6', 'B', '1', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4'):
                ...
                case 222:
                    ...
                    break
                case 223:
                    if ch in ('0', 'F', '9', 'b', 'E', '1', 'a', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D'):
                        states.append((228, self.reader.save()))
                        continue
                    break
                case 224:
                    if ch in ('f', 'a', '5', 'F', '0', 'A', 'b', 'E', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4'):
                        states.append((3, self.reader.save()))
                        continue
                    break
                case 225:
                    ...
                    break
                case 226:
                    if ch in ('D', 'e', '4', '9', 'E', 'f', 'a', '5', '0', 'F', 'A', '6', 'b', '1', 'd', 'B', '7', 'c', '2', 'C', '8', '3'):
                ...
                case 227:
                    ...
                    break
                case 228:
                    if ch in ('C', '9', 'E', '8', 'D', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7'):
                        states.append((230, self.reader.save()))
                        continue
                    break
                case 229:
                    if ch in ('7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', '1', 'a', '5', 'F', '0', 'A', 'b', '6', 'B', 'c'):
                        states.append((50, self.reader.save()))
                        continue
                    break
                case 230:
                    if ch in ('B', '8', 'D', '7', 'C', '9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6'):
                        states.append((52, self.reader.save()))
                        continue
                    break
                case _:
