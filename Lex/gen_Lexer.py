            ...
            match states[-1][0]:
                case 0:
                    ...
                    if ch in ('1', '2', '3', '4', '5', '6', '7', '8', '9'):
                        ...
                        continue
                    if ch in ('r', 's', 't', 'v', 'w', 'x', 'y', 'z', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'M', 'N', 'O', 'P', '_', 'Q', 'a', 'R', 'b', 'S', 'c', 'T', 'd', 'e', 'V', 'f', 'W', 'g', 'X', 'h', 'Y', 'i', 'Z', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q'):
                ...
                case 3:
                    if ch == '\\':
                        ...
                        continue
                    if ch in ('H', '3', 'm', 'I', '4', 'n', 'J', '5', 'o', 'K', '6', 'p', 'L', 'q', '7', 'M', '8', 'r', 'N', '9', 's', 'O', 't', 'P', '_', 'u', 'Q', 'a', 'v', 'R', 'b', 'w', 'l', 'S', 'c', 'x', 'T', 'd', 'y', 'U', 'e', 'z', 'V', 'f', 'A', 'W', 'g', 'B', 'X', 'h', 'C', 'Y', 'i', 'D', 'Z', 'j', 'E', '0', 'k', 'F', '1', 'G', '2'):
                        states.append((3, self.reader.save()))
                        continue
                ...
                case 8:
                    ...
                    if ch == '"':
                        states.append((14, self.reader.save()))
                        continue
                    if ch in ('H', '3', 'm', 'I', '4', 'n', 'J', '5', 'o', 'K', '6', 'p', 'L', 'q', '7', 'M', 'r', 'N', '9', 's', 'O', 't', 'P', '_', 'u', 'Q', 'a', 'v', 'R', 'b', 'w', 'l', 'S', 'c', 'x', 'T', 'd', 'y', 'U', 'e', 'z', 'V', 'f', 'A', 'W', 'g', 'B', 'X', 'h', 'C', 'Y', 'i', 'D', 'Z', 'j', 'E', '0', 'k', 'F', '1', 'G', '2'):
                        states.append((3, self.reader.save()))
                        continue
                    if self.other_identifier_continue(ch):
                        states.append((3, self.reader.save()))
                ...
                case 11:
                    ...
                    if ch == '"':
                        states.append((14, self.reader.save()))
                        continue
                    if ch in ('H', '3', 'm', 'I', '4', 'n', 'J', '5', 'o', 'K', '6', 'p', 'L', 'q', '7', 'M', '8', 'r', 'N', '9', 's', 'O', 't', 'P', '_', 'u', 'G', 'Q', 'a', 'v', 'R', 'b', 'w', 'S', 'c', 'x', 'T', 'd', 'y', 'U', 'e', 'z', 'V', 'f', 'A', 'W', 'g', 'B', 'X', 'h', 'C', 'Y', 'i', 'D', 'Z', 'j', 'E', '0', 'k', 'F', '1', 'l', '2'):
                        states.append((3, self.reader.save()))
                        continue
                    if self.other_identifier_continue(ch):
                        states.append((3, self.reader.save()))
                ...
                case 36:
                    ...
                    break
                case 37:
                    if ch in ('3', 'D', 'e', 'C', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', '0', 'b', '6', '1', 'B', 'c', '7', '2', 'd', '8'):
                ...
                case 46:
                    if ch == '.':
                        ...
                        continue
                    if ch in ('2', 'C', 'b', 'E', '3', 'D', 'c', 'F', '0', '4', 'd', 'a', '1', '5', 'e', '6', 'f', '7', 'A', '8', 'B', '9'):
                ...
                case 51:
                    ...
                    if ch == 'U':
                        ...
                        continue
                    if ch in ('b', "'", 'f', '"', 'n', '?', 'r', '\\', 't', 'a', 'v'):
                        states.append((53, self.reader.save()))
                        continue
                    if ch in ('6', '4', '1', '7', '5', '2', '3', '0'):
                ...
                case 73:
                    ...
                    break
                case 74:
                    if ch in ('e', '9', '4', 'E', 'f', 'a', 'D', '5', 'F', '0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3'):
                ...
                case 75:
                    ...
                    break
                case 76:
                    if ch in ('7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', 'B', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', '1', 'c'):
                ...
                case 85:
                    ...
                    if ch == 'W':
                        ...
                        continue
                    if ch in ('e', '7', 'E', 'A', 'f', '6', '8', 'F', 'B', '0', '9', 'C', '1', 'a', 'D', '2', 'b', '3', 'c', '4', 'd', '5'):
                        states.append((85, self.reader.save()))
                        continue
                    if ch in ('u', 'U'):
                    ...
                    break
                case 86:
                    if ch in ('e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', '0', 'b', '6', '1', 'B', 'D', 'c', '7', '2', 'C', 'd', '8', '3'):
                ...
                case 88:
                    ...
                    break
                case 89:
                    if ch in ('7', '2', 'C', 'd', '8', '3', 'D', '1', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', 'B', 'c'):
                ...
                case 90:
                    ...
                    break
                case 91:
                    if ch in ('a', '5', 'F', '0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', 'E', '4', 'f'):
                ...
                case 95:
                    ...
                    break
                case 96:
                    if ch in ('f', '3', 'e', '5', 'A', '4', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', '0', 'F', 'b', '1', 'c', '2', 'd'):
                ...
                case 107:
                    ...
                    break
                case 108:
                    if ch in ('2', 'd', 'C', '8', '3', 'e', 'D', '9', '4', 'f', 'E', 'a', '5', '0', 'A', 'F', 'b', '6', '1', 'B', 'c', '7'):
                        states.append((146, self.reader.save()))
                        continue
                    break
                case 109:
                    if ch in ('0', 'F', 'A', 'f', '6', 'b', '1', 'B', 'c', '7', '2', 'C', '8', 'd', '3', 'D', '9', 'e', '4', 'E', 'a', '5'):
                        states.append((147, self.reader.save()))
                        continue
                    break
                case 110:
                    if ch in ('b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '0', '9', '4', 'E', 'F', 'f', 'a', '5', 'A'):
                        states.append((148, self.reader.save()))
                        continue
                    break
                case 111:
                    if ch in ('e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', '0', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', 'D', '3'):
                ...
                case 123:
                    ...
                    if ch == 'p':
                        ...
                        continue
                    if ch in ('e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', '0', 'b', '6', '3', '1', 'B', 'c', '7', '2', 'C', 'd', '8', 'D'):
                        states.append((127, self.reader.save()))
                        continue
                    break
                case 124:
                    if ch in ('3', '0', '6', '1', '9', '4', '5', '7', '2', '8'):
                ...
                case 127:
                    ...
                    if ch == "'":
                        ...
                        continue
                    if ch in ('5', '0', 'A', 'F', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a'):
                        states.append((127, self.reader.save()))
                        continue
                    break
                case 128:
                    ...
                    break
                case 129:
                    if ch in ('b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', 'F', '8', '3', 'D', 'e', '0', '9', '4', 'E', 'f', 'a', '5', 'A'):
                ...
                case 130:
                    ...
                    if ch == "'":
                        states.append((93, self.reader.save()))
                        continue
                    if ch in ('1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', 'F', '0', 'b'):
                        states.append((130, self.reader.save()))
                        continue
                    if self.other_c_char(ch):
                        states.append((50, self.reader.save()))
                    ...
                    break
                case 131:
                    if ch in ('9', '4', 'D', 'f', 'E', 'a', '5', 'A', '0', 'F', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'e'):
                ...
                case 132:
                    ...
                    break
                case 133:
                    if ch in ('6', '0', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', 'b'):
                ...
                case 134:
                    ...
                    break
                case 135:
                    if ch in ('4', 'D', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', 'B', '1', 'c', '7', '2', 'C', 'd', '8', '3', 'e', '9'):
                ...
                case 136:
                    ...
                    break
                case 137:
                    if ch in ('B', '5', '7', 'A', 'C', '6', '8', 'D', '9', 'E', 'a', '0', 'F', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f'):
                ...
                case 138:
                    ...
                    if ch == '"':
                        states.append((52, self.reader.save()))
                        continue
                    if ch in ('b', '2', 'c', '3', 'd', '4', 'e', '5', 'f', '6', 'A', '7', 'B', '8', 'C', '9', 'D', 'a', 'E', 'F', '0', '1'):
                        states.append((138, self.reader.save()))
                        continue
                    if self.other_s_char(ch):
                        states.append((53, self.reader.save()))
                    ...
                    break
                case 139:
                    if ch in ('E', '8', 'D', 'a', '0', 'F', '9', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C'):
                ...
                case 140:
                    ...
                    break
                case 141:
                    if ch in ('A', '7', 'C', '6', 'B', '8', 'D', '9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5'):
                ...
                case 142:
                    ...
                    break
                case 143:
                    if ch in ('a', 'D', 'F', '9', '0', 'b', 'E', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8'):
                ...
                case 145:
                    ...
                    break
                case 146:
                    if ch in ('6', '1', 'B', '0', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'A', 'F', 'b'):
                        states.append((181, self.reader.save()))
                        continue
                    break
                case 147:
                    if ch in ('9', '4', 'E', 'f', 'D', 'a', '5', 'F', '0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'e'):
                        states.append((182, self.reader.save()))
                        continue
                    break
                case 148:
                    if ch in ('f', 'E', 'a', '5', 'F', '0', 'A', 'b', '6', 'B', '1', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4'):
                        states.append((3, self.reader.save()))
                        continue
                    break
                case 149:
                ...
                case 168:
                    ...
                    break
                case 169:
                    if ch in ('f', 'a', '5', '0', 'F', 'A', 'b', '1', '6', 'B', 'c', '2', '7', '4', 'C', 'd', '3', '8', 'D', 'e', '9', 'E'):
                ...
                case 171:
                    ...
                    break
                case 172:
                    if ch in ('5', 'F', '0', 'A', 'E', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'f', 'a'):
                ...
                case 173:
                    ...
                    if ch == "'":
                        states.append((93, self.reader.save()))
                        continue
                    if ch in ('b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', '0', 'E', 'a', 'F'):
                        states.append((173, self.reader.save()))
                        continue
                    if self.other_c_char(ch):
                        states.append((50, self.reader.save()))
                    ...
                    break
                case 174:
                    if ch in ('8', '3', 'D', 'e', '9', '4', 'E', 'f', 'C', 'a', '5', 'F', '0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'd'):
                        states.append((195, self.reader.save()))
                        continue
                    break
                case 175:
                    if ch in ('e', '5', 'A', '4', 'f', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3'):
                        states.append((196, self.reader.save()))
                        continue
                    break
                case 176:
                    if ch in ('8', 'D', '7', 'C', '9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B'):
                ...
                case 177:
                    ...
                    break
                case 178:
                    if ch in ('4', '6', 'f', 'B', '5', '7', 'A', 'C', '8', 'D', '9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e'):
                ...
                case 179:
                    ...
                    break
                case 180:
                    if ch in ('7', '9', 'C', 'E', '8', 'a', 'D', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B'):
                        states.append((199, self.reader.save()))
                        continue
                    break
                case 181:
                    if ch in ('a', '5', 'F', '0', 'A', 'b', 'E', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'f'):
                        states.append((3, self.reader.save()))
                        continue
                    break
                case 182:
                    if ch in ('8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', 'C', '5', 'F', '0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'd'):
                ...
                case 185:
                    ...
                    break
                case 186:
                    if ch in ('3', '6', '1', '9', '4', '7', '2', '5', '0', '8'):
                        states.append((161, self.reader.save()))
                        continue
                    break
                case 187:
                    if ch in ('1', '9', '4', '7', '8', '2', '5', '0', '3', '6'):
                        states.append((188, self.reader.save()))
                        continue
                    break
                case 188:
                ...
                case 190:
                    ...
                    break
                case 191:
                    if ch in ('6', '1', '9', '4', '7', '2', '5', '8', '0', '3'):
                        states.append((165, self.reader.save()))
                        continue
                    break
                case 192:
                    if ch in ('3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8'):
                        states.append((50, self.reader.save()))
                        continue
                    break
                case 193:
                    if ch in ('1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', 'b', '0', '6'):
                        states.append((206, self.reader.save()))
                        continue
                    break
                case 194:
                    if ch in ('9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', 'D', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'e'):
                        states.append((207, self.reader.save()))
                        continue
                    break
                case 195:
                    if ch in ('7', '2', 'd', 'C', '8', '3', 'e', 'D', '9', '4', '1', 'f', 'E', 'a', '5', '0', 'A', 'F', 'b', '6', 'B', 'c'):
                ...
                case 196:
                    ...
                    break
                case 197:
                    if ch in ('7', 'A', 'C', '6', '8', 'B', 'D', '9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5'):
                        states.append((209, self.reader.save()))
                        continue
                    break
                case 198:
                    if ch in ('f', '3', '5', 'e', 'A', '4', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', '0', 'F', 'b', '1', 'c', '2', 'd'):
                        states.append((210, self.reader.save()))
                        continue
                    break
                case 199:
                    if ch in ('C', '6', 'B', '8', 'D', '7', '9', 'E', 'a', '0', 'F', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A'):
                ...
                case 203:
                    ...
                    break
                case 204:
                    if ch in ('4', '9', '7', '2', '5', '0', '8', '3', '6', '1'):
                        states.append((188, self.reader.save()))
                        continue
                    break
                case 205:
                    if ch in ('4', '7', '2', '5', '0', '8', '3', '9', '6', '1'):
                        states.append((189, self.reader.save()))
                        continue
                    break
                case 206:
                    ...
                    break
                case 207:
                    if ch in ('d', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '0', '5', 'F', 'A', '2', 'b', '6', '1', 'B', 'c', '7', 'C'):
                        states.append((50, self.reader.save()))
                        continue
                    break
                case 208:
                    if ch in ('0', 'A', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'F', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5'):
                ...
                case 210:
                    ...
                    break
                case 211:
                    if ch in ('6', 'B', '5', 'A', '7', 'C', '8', 'D', '9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2', 'd', '3', 'e', '4', 'f'):
                ...
                case 214:
                    ...
                    break
                case 215:
                    if ch in ('e', '9', '4', 'E', 'f', 'a', '5', 'F', 'A', '0', 'b', '6', '1', 'B', 'c', 'D', '7', '2', 'C', 'd', '8', '3'):
                ...
                case 216:
                    ...
                    break
                case 217:
                    if ch in ('4', 'd', 'f', '3', '5', 'e', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', 'F', '0', 'b', '1', 'c', '2'):
                ...
                case 218:
                    ...
                    break
                case 219:
                    if ch in ('7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '1', '6', 'B', 'c'):
                        states.append((3, self.reader.save()))
                        continue
                    break
                case 220:
                    if ch in ('c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'F', '0', 'A', 'b', '1', '6', 'B'):
                ...
                case 221:
                    ...
                    break
                case 222:
                    if ch in ('2', 'd', '1', 'c', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a', 'F', '0', 'b'):
                ...
                case 224:
                    ...
                    break
                case 225:
                    if ch in ('b', '6', '0', '1', 'B', 'c', '7', 'F', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'E', 'f', 'a', '5', 'A'):
                        states.append((50, self.reader.save()))
                        continue
                    break
                case 226:
                    if ch in ('1', 'B', 'A', '7', 'c', '2', 'C', '8', 'd', '3', 'D', '9', 'e', '4', 'E', 'a', 'f', '5', 'F', '0', 'b', '6'):
                        states.append((229, self.reader.save()))
                        continue
                    break
                case 227:
                    if ch in ('1', 'a', 'c', '0', 'F', '2', 'b', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E'):
                        states.append((53, self.reader.save()))
                        continue
                    break
                case 228:
                    if ch in ('F', 'c', '0', 'b', '2', 'd', '1', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9', 'E', 'a'):
                        states.append((230, self.reader.save()))
                        continue
                    break
                case 229:
                    if ch in ('a', '5', 'F', '0', 'A', 'E', 'b', '6', '1', 'B', 'c', '7', '2', 'C', 'd', '8', '3', 'D', 'e', '9', '4', 'f'):
                        states.append((50, self.reader.save()))
                        continue
                    break
                case 230:
                    if ch in ('0', 'E', 'b', 'a', '1', 'F', 'c', '2', 'd', '3', 'e', '4', 'f', '5', 'A', '6', 'B', '7', 'C', '8', 'D', '9'):
                        states.append((53, self.reader.save()))
                        continue
                    break
                case _:
